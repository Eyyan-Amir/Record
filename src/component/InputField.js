					...
					<form className='' onSubmit={handleSubmit}>
						<div className='row'>
							...
							<div className='col-md-2'>
								<input
									...
									value={value.advance}
									className='form-control'
									onChange={(event) => handleChange("advance", event.target.value)}
								/>
							</div>
							<div className='col-md-2'>
								<input
						...
						<div className='row'>
							<div className='col-md-8'>
								<button type='submit' className='addBtn btn btn-primary' onClick={handleSave}>
									ADD
								</button>
							</div>
							<div className='col-md-4'>
								<button className='histBtn btn btn-danger' onClick={showModal}>
									History
								</button>
							</div>
						</div>
